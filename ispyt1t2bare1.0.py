...
root = Tk()
root.title("Crack the Code. Build the code. Fly red arrow ")
...
def pad2():
    ...
    frame4 = Frame(frame3, bg = "light yellow", padx=20, pady = 0)
    ...
    left_entry = Entry(mainframe3, bd = 5, width = 6, textvariable = degrees_left,  font= programFont14, bg = 'light yellow')
    ...
    right_entry = Entry(mainframe5, bd = 5, width = 6, textvariable = degrees_right,  font= programFont14, bg = 'light yellow')
   ...
   ################################### repeat control structure #############################################################
    ...
    colourlab =Label(user_mainframe1, font= italicFont14, text="colour", width = 8)
    colourlab.grid(column=0, row=0, sticky=(N,W,E,S))
    colourlab['background'] = 'silver'
    colourlab['anchor'] = 'w'

    cbtn1 = Button(user_mainframe1, text="red", font= programFont14, bg = "red", fg = "white", width = 5,command = red)
    cbtn1.grid(column = 1, row =0, sticky = (N,W))        
    cbtn1['relief'] = 'raised'
    cbtn1['borderwidth'] = 5

    v_cem10 = Frame(user_mainframe1, bg= "silver", width = v_cement)
    v_cem10.grid(column=2, row= 0, sticky = (W))
    

    
    cbtn2 = Button(user_mainframe1, text="blue", font= programFont14, bg = "blue",fg = "white", width = 5,command = blue)
    cbtn2.grid(column = 3, row =0, sticky = (N,E,W,S))
    cbtn2['relief'] = 'raised'
    cbtn2['borderwidth'] = 5

    v_cem11 = Frame(user_mainframe1, bg= "silver", width = v_cement)
    v_cem11.grid(column=4, row= 0, sticky = (W)) 

    
    cbtn3 = Button(user_mainframe1, text="green", font= programFont14, bg = "green",fg = "white", width = 5,command = green)
    cbtn3.grid(column = 5, row =0, sticky = (N,W))
    cbtn3['relief'] = 'raised'
    cbtn3['borderwidth'] = 5

    v_cem12 = Frame(user_mainframe1, bg= "silver", width = v_cement)
    v_cem12.grid(column=6, row= 0, sticky = (W)) 

    cbtn4 = Button(user_mainframe1, text="black", font= programFont14, bg = "black",fg = "white", width = 5,command = black)
    cbtn4.grid(column = 7, row =0, sticky = (N,W))
    cbtn4['relief'] = 'raised'
    cbtn4['borderwidth'] = 5

    v_cem13 = Frame(user_mainframe1, bg= "silver", width = v_cement)
    v_cem13.grid(column=8, row= 0, sticky = (W)) 

    cbtn5 = Button(user_mainframe1, text="gold", font= programFont14, bg = "gold",fg = "black", width = 5,command = gold)
    cbtn5.grid(column = 9, row =0, sticky = (N,W))
    cbtn5['relief'] = 'raised'
    cbtn5['borderwidth'] = 5

    v_cem14 = Frame(user_mainframe1, bg= "silver", width = v_cement)
    #v_cem14.grid(column=10, row= 0, sticky = (W)) 
    
    cbtn6 = Button(user_mainframe1, text="white", font= programFont14, bg = "white",fg = "black", width = 5,command = white)
    ...
    magicbox = Label(user_mainframe2, font= italicFont14, text="magic box", width = 8)
    magicbox.grid(column=0, row=0, sticky=(N,W,E,S))
    magicbox['background'] = 'silver'
    magicbox['anchor'] = 'w'

    magicbtn1 = Button(user_mainframe2, text="box 1,0", font= programFont14, bg = "light green", fg = "black", width = 7,command = magic10)
    ...
    magicbtn2 = Button(user_mainframe2, text="box 0,1", font= programFont14, bg = "light green", fg = "black", width = 7,command = magic01)
    magicbtn2.grid(column = 2, row =0, sticky = (N,W))        
    magicbtn2['relief'] = 'raised'
    magicbtn2['borderwidth'] = 5
    magicbtn2['anchor'] = 'w'

    magicbtn3 = Button(user_mainframe2, text="box 1,1", font= programFont14, bg = "light green", fg = "black", \
    ...
    magicbtn4 = Button(user_mainframe2, text="box", font= programFont14, bg = "light green", fg = "black", width = 3,\
                       command = magic_trick)
    ...
    usermagic1 = Entry(user_mainframe2,bd = 6, width = 2, textvariable = magic1, font= programFont14, bg = 'light green')
    usermagic1.grid(column=5, row=0, sticky= (W,E))

    usermagic2 = Entry(user_mainframe2,bd = 6, width = 2, textvariable = magic2, font= programFont14, bg = 'light green')
    ...
    gridlab = Label(user_mainframe5, font= italicFont14, text="grid size", width = 8)
    gridlab.grid(column=0, row=0, sticky=(N,W,E,S))
    gridlab['background'] = 'silver'
    gridlab['anchor'] = 'w'
   
    btn_grid5 = Button(user_mainframe5, text=" 5x5", font= programFont14, bg = "light blue", width = 5,  command = grid_5)
    btn_grid5.grid(column=1, row=0, sticky= (N,W))
    btn_grid5['relief'] = 'raised'
    btn_grid5['borderwidth'] = 5
    btn_grid5['anchor'] = 'w'

    v_cem30 = Frame(user_mainframe5, bg= "silver", width = v_cement)
    v_cem30.grid(column=2, row=0, sticky = (W)) 

    btn_grid10 = Button(user_mainframe5, text="10x10", font= programFont14, bg = "light blue", width = 5,  command = grid_10)
    btn_grid10.grid(column=3, row=0, sticky= (N,W))
    btn_grid10['relief'] = 'raised'
    btn_grid10['borderwidth'] = 5
    btn_grid10['anchor'] = 'w'

    v_cem31 = Frame(user_mainframe5, bg= "silver", width = v_cement)
    v_cem31.grid(column=4, row= 0, sticky = (W))  

       
    btn_grid20 = Button(user_mainframe5, text="20x20", font= programFont14, bg = "light blue", width = 5,  command = grid_20)
    btn_grid20.grid(column=5, row=0, sticky= (N,W))
    btn_grid20['relief'] = 'raised'
    btn_grid20['borderwidth'] = 5
    btn_grid20['anchor'] = 'w'

    v_cem32 = Frame(user_mainframe5, bg= "silver", width = v_cement)
    v_cem32.grid(column=6, row= 0, sticky = (W)) 


    btn_nogrid = Button(user_mainframe5, text="no grid", font= programFont14, bg = "light blue", width = 7, command = gridless)
    btn_nogrid.grid(column=7, row=0, sticky= (N,W))
    btn_nogrid['relief'] = 'raised'
    btn_nogrid['borderwidth'] = 5
    btn_nogrid['anchor'] = 'w'

    btn_program = Button(user_mainframe5, text="program", font= programFont14, bg = "light blue", width = 7, command = gridless)
    btn_program.grid(column=8, row=0, sticky= (N,W))
    btn_program['relief'] = 'raised'
    btn_program['borderwidth'] = 5
    btn_program['anchor'] = 'w'

    col = "light yellow"
    filler502= Frame(frame4, height=200, bg=col)
    filler502.grid(column=0, row=3, sticky=(N, W, E))

    print("exiting from pad2() after setting up pad2")
...
def pad1():
    ...
    frame4 = Frame(frame3, bg = "light yellow", padx=3, pady = 0)
    frame4.grid(row = 1, column = 0, sticky= (N,E,W,S) )
    ...
    v_cem224 = Frame(mainframe3, bg= "silver", width = v_cement)
    v_cem224.grid(column=9, row= 0, sticky = (W)) 

    uplbtn = Button(mainframe3, text="unplugged", font= programFont14, bg = "light blue", width = 9,\
                    command = display_upl)
    uplbtn.grid(column = 10, row = 0, sticky = (N,W))
...
#####################################rectangle #################################    
    ...
    pybtn = Button(mainframe11, text="python", font= programFont14, bg = "light blue", width = 6,command = fetchout_choose)
    pybtn.grid(column = 12, row = 0, sticky = (N,W))
    pybtn['relief'] = 'raised'
    pybtn['borderwidth'] = 5
    ...
    fillerb50= Frame(mainframe8, height=4, bg= "silver")
...
def padtwo():
    ...
    padhead = Label(pad_box, font= boldFont16, text=" Toolbox 2: Symmetry and Repetition", width = 40, height = 2)
    padhead.grid(row=0, column=0, sticky = (N,E,W,S))
    padhead['background'] = 'silver'
   ...
   ################################### repeat control structure #############################################################
    ...
    fetch_entry = Entry(mainframe9, bd = 5, width = 2, textvariable = fetch_paces, \
                        font= programFont14, bg = 'light green')
    fetch_entry.grid(column=10, row= 0, sticky= (N,W,S))
    #fetch_entry.bind("<FocusIn>", forward_act)
    ...
    if allow:
        ...
        if ddd.isdigit():###&&&&& test  value entered                
            ...
            if ok_repeat == True:
                ...
                #####################    
                allow=True        
                progdisplay()#displays via ecode in program_box
                allow=False
                ###################### 
...
def drive_milly(fn = None):
    ...
    if allow == True:
        ...
        if missionCount == 3 or missionCount == 4:
            print('top is', top)
            print('recordmypy is', recordmypy)
            rrr=''.join(record)
            print('in drive_milly, rrr is', rrr)
            ecode.set(rrr)
...
###################################### in left() inside repeat  ####################################################
        ...
        if ok_repeat == True:#&&& finish
            ...
            top = top+1
            if fix_angle == 90:
                record.append('rt ')# for right turn
                recordmypy.append('\nmy.rt(' + angle + ')')
            else:
            ...
            if missionCount == 3 or missionCount == 4:
                ...
                print('recordmypy is', recordmypy)
                rrr=''.join(record)
                print('in right(), ''.join(record) is', rrr)
                ecode.set(rrr)
        my.st()
        allow = True # let other events in now
            #else:
...
def full_delete(): ##&&&&&&&&&& no repeats to handle
    ...
    if allow==True:
        ...
        # e.g. p,n,fun1,2,3 ie user_functionspy  
        ...
        print('in full_delete, arc_record is', arc_record, 'arc_recordmypy is', arc_recordmypy)
        pad=True # sets toggle to show pad of Toolbox/ drawing solutions to programs
        ecode.set('')
        allow=True
        top=-1
        record=[]
    ...
    #pad = True # toggle switch between the Toolbox pad and Solutions table
        #p=100 # grid square size in pixels 
        #n=5 # 5x5 grid
        #j=0 # counter for 'programs' to be cracked
        #
        #mission = ["filler", progs1, progs2, progs3]
        #missionCount=1
        #proglimit =12
        #progs=mission[missionCount]
        #code.set(progs[0])
    '''
        print('in full_delete,'', i)
        if ok_repeat == True:
            print("in full_delete. in_repeat_code is", i)
            in_repeat_code.set("**") #########&&&&&&&&&&&&&&&&&&&&&&&
        ...
        print("hangfire full_delete")
        '''


    
def progdisplay():
    '''displays via ecode in program_box'''
    global allow
    global record
    
    if allow:
        allow = False
        program_box.configure(font=programFont14, wraplength = 440, width = 42)
        ecode.set(''.join(record))
        print('record is', record)
        allow=True
    else:
        print('in progdisplay(),  spin')
...
'''    
    ...
    if allow == True:
        ...
        if  uplshow ==True:
            ...
            x=ucode.get()
            print(''.join(record))
            label_instruction.config(background= 'light yellow' )
            ucode.set(''.join(record))
            frame3.after(100, lambda: frame3.focus_force())# 
            
            for child in frame4.winfo_children():
                    child.destroy()
            label_uplcode.config(background= 'yellow',wraplength= 350, width=30, font = programFont14, padding="25,0,25,0" )
            uplcode.set(''.join(record))
            frame4.after(100, lambda: frame4.focus_force())#
...
def start():
    ...
    program_box.configure(background='light yellow',wraplength= 440, width = 40, padding="0", font=boldFont14)  
...
as you build it, an instruction at a time. Use the 'newline' button in Toolbox 1 to arrange your code to pick out\
 the repetitions in your code. \n\n\n\n\n")
    ...
    ################### 10 branch tree in frame 02s #################################################################

    box = Frame(frame2, background="light yellow"  )# container
    box.grid(row = 0, column = 0, sticky = (N))    

    tools = Frame(frame2, background="light yellow"  )# container
    tools.grid(row = 2, column = 0, sticky = (N) )   

    space1018= Frame(frame2,height=200, bg="light yellow")
    space1018.grid(row=9, column=0, sticky=(N, W, E, S))


    #####################  branch 1 box  ###########################################

    space10= Frame(box,height=10, bg="light yellow")
    space10.grid(column=0, row=0, sticky=(N, W, E, S))

    startButton1 = Button(box, text = "Start",  height = 1, width=9, command = start, background = "light yellow")
    startButton1.grid(column=0, row=1, sticky=(N))
    startButton1['relief'] = 'raised'
    startButton1['borderwidth'] = 3

    space1017= Frame(box,height=10, bg="light yellow")
    space1017.grid(column=0, row=2, sticky=(N, W, E, S))


    ##################### branch 2  tools  #########################################


    toolButton1 = Button(tools, text = "Toolbox 1",  height = 1,width=9, command = toolbox1, background = "light blue")
    toolButton1.grid(column=0, row=0, sticky=(N,W,E))
    toolButton1['relief'] = 'raised'
    toolButton1['borderwidth'] = 3
     
    toolButton2 = Button(tools, text = "Toolbox 2",  width=9, height = 1, command = toolbox2, background = "light blue")
    toolButton2.grid(column=0, row=1, sticky=(N,W,E))
    toolButton2['relief'] = 'raised'
    toolButton2['borderwidth'] = 3

    toolButton3 = Button(tools, text = "Toolbox 3",  height = 1, width=9,command = toolbox3, background = "light blue")
    toolButton3.grid(column=0, row=2, sticky=(N,W,E))
    toolButton3['relief'] = 'raised'
    toolButton3['borderwidth'] = 3
...
##################################   Frame03s   #########################################################
    ...
    label_instruction.config(background='light yellow',wraplength= 500, width=47,  font = boldFont16, padding="10 20 10 20" )
    ucode.set("          Welcome to ISPY Programming\n\n1. Messages, instructions, missions and your final programs \
in Python 3 are displayed here.\n\n2. If you are just starting, click on 'Toolbox1' in the middle column.\
Otherwise select the toolbox you want  to work with.\n\n3. Click 'Start' at any point to choose another Toolbox, or more options from the middle column\n")
...
##################################  frame 04s  #######################################################
    ...
    frame4 = Frame(frame3, bg = "light yellow", padx=100, pady = 50)
    frame4.grid(row = 1, column = 0, sticky= (N,E,W,S) )

    fillerhvar= Frame(frame4,height=2, bg="light yellow")
    fillerhvar.grid(column=0, row=0, sticky=(N, W, E,S))
        
    pad_box = Frame(frame4)
    pad_box.grid(column=0, row=1, sticky=(N, W, E))
    pad_box['relief'] = 'raised'
    pad_box['borderwidth'] = 8
    pad_box['background'] = 'silver'
    ...
    pad_lab =Label(pad_box, text = " Your Toolbox Site", font='boldFont16', padx=25, pady=35, background="silver")
    pad_lab.grid(column=0,row=0, sticky=(N,E,W,S))

    fillerh120= Frame(frame4,height=200, bg="light yellow")
    fillerh120.grid(column=0, row=2, sticky=(N, W, E, S))
...
def toolbox1() :#switches to instruction pad  
...
as you build it, an instruction at a time. Use the 'newline' button in Toolbox 1 to arrange your code to pick out\
 the repetitions in your code. \n\n\n\n\n")       
    if allow:
        ...
        label_instruction.config(background='light yellow',wraplength= 550, width=51,  font = boldFont14,\
                                     padding=" 10 5 10 5" )
        ucode.set("                              Toolbox 1\n\n1. Fly the red arrow to explore or tackle your next assignment.\n\
2. Use the  click/touch drawing screen pad below,  to build your program.\
\n3.")  
        pad1()
        program_box.config(background='light yellow')

        ecode.set("\nWait for the blue arrow to draw the grid on which to fly, and for the red arrow to dock \
in the space station at the origin, before flying the red arrow.\n\n")    
        time.sleep(.5)
        ecode.set("                    Program Record\n\nYour program is  recorded here, \
as you build it, an instruction at a time. Use the 'newline' button in Toolbox 1 to arrange your code to pick out\
the repetitions in your code. \n\n\n\n\n")
        #screen.bgcolor("red") # Set the background color
        
         ################################ START OF GRID SET UP PROGRAM  ActionT1! #######################################


    
        if first_time:# slow execution for introduction/first time in toolbox1
            label_instruction.config(background='light yellow',wraplength= 550, width=51,  font = boldFont14,\
                                     padding=" 10 5 10 5" )
            ucode.set("                              Toolbox 1\n\n1. Fly the red arrow for your next assignment.\n\
2. Use the  click/touch drawing screen pad below, or the arrow keys on your keyboard, to build your program.\
\n3. Click on the next mission you want to tackle.") 
            ...
            allow=True #allow events to operate
            first_time=False
            ...
            allow=False
            ##################################
            program_box.configure(background='light yellow',wraplength= 400, width = 40, padding="0", font=boldFont16)  
            ecode.set("\n Examples of the unique patterns you will be able to design with the Toolboxes on this course.\n\n\n\n\n")
            #label_instruction.config(background='light green',wraplength= 550, width=52,  font = boldFont14,\
                                     #padding=" 10 10 10 10" )
            #ucode.set(" ") 
            program_box.configure(background='light yellow',wraplength= 440, width = 40, padding="0", font=boldFont16)  
...
def toolbox2():    
    ...
    label_instruction.config(background = "light yellow",font=boldFont14, width= 35, wraplength =360 )
    ucode.set("hold")
...
def toolbox3():#switches to instruction tool box 
...
def square2():
    print("square 2 paces")

def square3():
    print("square 5 paces")

def square4():
    print("square 4 paces")
    ...
    if ok_repeat == True: # no drawing: in repeat section to be saved for repeat execution
        ...
        if allow == True:
            ...
            if missionCount == 3 or missionCount == 4:
                ...
                print('recordmypy is', recordmypy)
                rrr=''.join(record)
                print('in red_all miss3, rrr is', rrr)
                ecode.set(rrr)
            allow=True
...
startButton1 = Button(box, text = "Start",  height = 1, width=9, command = start, background = "light blue")
startButton1.grid(column=0, row=1, sticky=(N))
startButton1['relief'] = 'raised'
startButton1['borderwidth'] = 3
...
pad_box = Frame(frame4, padx=5, pady =5)
pad_box.grid(column=0, row=1, sticky=(N, W, E))
pad_box['relief'] = 'raised'
pad_box['borderwidth'] = 8
pad_box['background'] = 'silver'
...
colourlab = Label(mainframe6, font= programFont14, text="colour", width = 10)
colourlab.grid(column=0, row=0, sticky=(N,W,E,S))
colourlab['background'] = 'silver'
colourlab['anchor'] = 'w'

cbtn1 = Button(mainframe6, text="red", font= programFont14, bg = "red", fg = "white", width = 5,command = red)
cbtn1.grid(column = 1, row =0, sticky = (N,W))        
cbtn1['relief'] = 'raised'
cbtn1['borderwidth'] = 5

v_cem10 = Frame(mainframe6, bg= "silver", width = v_cement)
v_cem10.grid(column=2, row= 0, sticky = (W)) 


cbtn2 = Button(mainframe6, text="blue", font= programFont14, bg = "blue",fg = "white", width = 5,command = blue)
cbtn2.grid(column = 3, row =0, sticky = (N,E,W,S))
cbtn2['relief'] = 'raised'
cbtn2['borderwidth'] = 5

v_cem11 = Frame(mainframe6, bg= "silver", width = v_cement)
v_cem11.grid(column=4, row= 0, sticky = (W)) 


cbtn3 = Button(mainframe6, text="green", font= programFont14, bg = "green",fg = "white", width = 6,command = green)
cbtn3.grid(column = 7, row =0, sticky = (N,W))
cbtn3['relief'] = 'raised'
cbtn3['borderwidth'] = 5

v_cem12 = Frame(mainframe6, bg= "silver", width = v_cement)
v_cem12.grid(column=8, row= 0, sticky = (W)) 

cbtn4 = Button(mainframe6, text="black", font= programFont14, bg = "black",fg = "white", width = 6,command = black)
cbtn4.grid(column = 9, row =0, sticky = (N,W))
cbtn4['relief'] = 'raised'
cbtn4['borderwidth'] = 5

v_cem13 = Frame(mainframe6, bg= "silver", width = v_cement)
v_cem13.grid(column=10, row= 0, sticky = (W)) 

cbtn5 = Button(mainframe6, text="gold", font= programFont14, bg = "gold",fg = "black", width = 6,command = gold)
cbtn5.grid(column = 11, row =0, sticky = (N,W))
cbtn5['relief'] = 'raised'
cbtn5['borderwidth'] = 5

v_cem14 = Frame(mainframe6, bg= "silver", width = v_cement)
v_cem14.grid(column=12, row= 0, sticky = (W)) 

cbtn6 = Button(mainframe6, text="white", font= programFont14, bg = "white",fg = "black", width = 6,command = white)
cbtn6.grid(column = 13, row =0, sticky = (N,W))
cbtn6['relief'] = 'raised'
cbtn6['borderwidth'] = 5
...
ufetch =Label(mainframe7, font= programFont14, text="fetch", width = 10)
ufetch.grid(row=0, column=0, sticky = (W))
ufetch['anchor'] = 'w'
ufetch['background'] = 'silver'
                                        
febtn1 = Button(mainframe7, text="fe1", font= programFont14, bg = "light green", width = 5,command = fetchout1)
febtn1.grid(column = 1, row =0, sticky = (N,W))        
febtn1['relief'] = 'raised'
febtn1['borderwidth'] = 5

v_cem20 = Frame(mainframe7, bg= "silver", width = v_cement)
v_cem20.grid(column=2, row= 0, sticky = (W))

febtn2 = Button(mainframe7, text="fe2", font= programFont14, bg = "light green", width = 5,command = fetchout2)
febtn2.grid(column = 3, row =0, sticky = (N,W))
febtn2['relief'] = 'raised'
febtn2['borderwidth'] = 5

v_cem21 = Frame(mainframe7, bg= "silver", width = v_cement)
v_cem21.grid(column=4, row= 0, sticky = (W))

febtn3 = Button(mainframe7, text="fe3", font= programFont14, bg = "light green", width = 5,command = fetchout3)
febtn3.grid(column = 5, row =0, sticky = (N,W))
febtn3['relief'] = 'raised'
febtn3['borderwidth'] = 5

v_cem22 = Frame(mainframe7, bg= "silver", width = v_cement)
v_cem22.grid(column=6, row= 0, sticky = (W))

febtn4 = Button(mainframe7, text="fe4", font= programFont14, bg = "light green", width = 5,command = fetchout4)
febtn4.grid(column = 7, row =0, sticky = (N,W))
febtn4['relief'] = 'raised'
febtn4['borderwidth'] = 5

v_cem23 = Frame(mainframe7, bg= "silver", width = v_cement)
v_cem23.grid(column=8, row= 0, sticky = (W)) 
...
fechoose = Button(mainframe7, text="fe", font= programFont14, bg = "light green", width = 3,command = fetchout_choose)
fechoose.grid(column = 9, row = 0, sticky = (N,W))
fechoose['relief'] = 'raised'
fechoose['borderwidth'] = 5


fetch_entry = Entry(mainframe7, bd = 5, width = 2, textvariable = fpaces, \
                    font= programFont14, bg = 'light green')
fetch_entry.grid(column=10, row= 0, sticky= (N,W,S))
#fetch_entry.bind("<FocusIn>", forward_act)
...
fillerm12= Frame(mainframe7, height= 3*h_cement, bg= "silver")
fillerm12.grid(column= 11, row=1, sticky=(N, W, E))
...
repeat_btn= Button(mainframe8, text="repeat", width = 6, font = programFont16, command = setup_repeat)
repeat_btn.grid(column=0, row=1, sticky=(W))
repeat_btn['background'] = 'light yellow'

filler25= Frame(mainframe8, width = 4)
filler25.grid(column=1, row=1, sticky=(N, W, E, S))
filler25['background'] = 'silver'
...
times = StringVar()
times.set('')
tim = Entry(mainframe8,bd = 5, width = 2, textvariable = times,  font= programFont14, bg = 'light yellow')
tim.grid(column=2, row=1, sticky= (E,W))
tim.bind("<FocusIn>", act)


filler3= Frame(mainframe8, width = 2)
filler3.grid(column=3, row=1, sticky=(N, W,E,S))
filler3['background'] = 'silver'

bracketleft = Label(mainframe8, text='[', font= programFont32, bg = "silver", width = 1)
bracketleft.grid(column=4, row=1, sticky= (N))


brackets = Label(mainframe8, text=in_repeat_code,textvariable = in_repeat_code, font= programFont18,\
                 bg = "light yellow", width = 32)
brackets.grid(column=5, row=1, sticky= (W,E))
brackets.configure(font=programFont12)
in_repeat_code.set('***')

bracketright = Label(mainframe8, text=']', font= programFont32, bg = "silver", width = 1)
bracketright.grid(column=6, row=1, sticky= (N,W))

filler4= Frame(mainframe8, width = 2)
filler4.grid(column=7, row=1, sticky=(N, W, E, S))
filler4['background'] = 'silver'

gobtn = Button(mainframe8, text="do it", font= programFont16, bg = "light yellow",  command = execute_repeat, width = 5)
gobtn.grid(column=8, row=1, sticky= (E,W))
...
frame4 = Frame(frame3, bg = "light yellow", padx=100, pady = 10)
frame4.grid(row = 1, column = 0, sticky= (N,E,W,S) )
...
pad_lab =Label(pad_box, text = " Your Toolbox Site", font='boldFont16', padx=25, pady=55, background="silver")
pad_lab.grid(column=0,row=0, sticky=(N,E,W,S))
...
############################### After Set up:  DATA and INITIALISATION VARIABLES #####################################
...
################################## Data: Mission programs   #############################################




################### initialising the variables pad, p, user_functionspy ####################################
...
index12=1# index for toolbox 1/mission2
index=1# index for toolbox 1/mission1 
...
gou = [] # text upl program for repeat as a list
pad = True # sets up the Toolbox pad and hides Solutions table
insol = False
fix_angle = 0
...
record = []# list holding record of program to be printed in
                      # Python Interactive shell
recordpy = []#py code for display program
recordmypy = []# mypy code for exec
